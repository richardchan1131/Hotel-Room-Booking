...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Modules\Agency\Controllers';

    protected $adminModuleNamespace = 'Modules\Agency\Admin';
    ...
    /**
     * Define thepublish  "api" routes for the application.
     *
