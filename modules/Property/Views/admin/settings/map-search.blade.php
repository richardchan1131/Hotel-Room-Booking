                                ...
                                <div class="item" data-number="{{$key}}">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <label >{{__("Size")}}</label>
                                            <select name="property_map_search_fields[{{$key}}][size]" class="custom-select">
                                                <option value="">{{__("-- Select Size --")}}</option>
                                                @foreach(range(1,12) as $size)
                                                    <option @if(($item['size'] ?? '') == $size) selected @endif value="{{$size}}">{{$size}}/12</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select __name__="property_map_search_fields[__number__][size]" class="custom-select">
                                            <option value="">{{__("-- Select Size --")}}</option>
                                            @foreach(range(1,12) as $size)
                                                <option value="{{$size}}">{{$size}}/12</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-1">
