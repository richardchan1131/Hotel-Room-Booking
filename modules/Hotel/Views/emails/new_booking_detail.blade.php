        ...
        <table class="b-table" cellspacing="0" cellpadding="0">
            ...
            @if ($booking->additional_details)
                ...
                @if (isset($additional->meals))
                    <tr>
                        <td class="label">{{ __('Meals') }}</td>
                        <td class="val no-r-padding">
                            <strong>{{ $additional->meals[0] }}</strong>
                        </td>
                    </tr>
                @endif
                @if (isset($additional->additional_bed) && $additional->additional_bed != 'false')
                    <tr>
                        <td class="label">{{ __('Supplymentary bed') }}</td>
                        <td class="val no-r-padding">
                ...
                @if (isset($additional->freecancelation))
                    <tr>
                        <td class="label">{{ __('Free cancelation') }}</td>
                        <td class="val no-r-padding">
                            <strong>{{ __('Yes') }}</strong>
                        </td>
                    </tr>
                ...
                @if (isset($additional->children))
                    @foreach ($additional->children as $children)
                        <tr>
                            <td class="label">{{ __('Children') }}</td>
                            <td class="val no-r-padding">
                                <strong>{{ $children }} {{ __('years old') }}</strong>
                            </td>
                        </tr>
                    @endforeach
                @endif
