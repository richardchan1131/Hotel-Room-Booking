                ...
                <div class="room-item border-light rounded-4 px-30 py-30 sm:px-20 sm:py-20" :class="{ 'mt-20': index }"
                    ...
                    <div class="roomGrid">
                        <div class="roomGrid__header">
                            <div class="type_benefit">
                                <div class="room_type">{{ __('Room Type') }}</div>
                                <div class="benefits_header">{{ __('Benefits') }}</div>    
                            </div>
                            
                            <div class="select_room">{{ __('Select Rooms') }}</div>
                        </div>
                                            ...
                                            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        From the generous terrace of the Patagonia room, you can enjoy the mountain view, relaxing with a cup of coffee in hand.
                                                        The room is equipped with a matrimonial bed size 180x200 and 1 sofa bed.
                                                        Private bathroom with shower cabin, underfloor heating, hair dryer, sanitary items (dental kit, shampoo, shower gel).
                                                        </div>
                                                        ...
                                                        <div class="d-flex items-center" v-if="room.suplimentaryOlteanu.double_bed > 0">
                                                            ...
                                                            <div class="ml-10">
                                                                @{{ room.suplimentaryOlteanu.double_bed }} <span
                                                                    v-if="room.suplimentaryOlteanu.double_bed == 1">{{ __('dobule bed included.') }}</span>
                                                                <span
                                                                    v-if="room.suplimentaryOlteanu.double_bed > 1">{{ __('double beds included.') }}</span>
                                                            </div>
                                                        </div>
                                                        {{-- single bed --}}
                                                        <div class="d-flex items-center" v-if="room.suplimentaryOlteanu.single_bed > 0">
                                                            ...
                                                            <div class="ml-10">
                                                                @{{ room.suplimentaryOlteanu.single_bed }} <span
                                                                    v-if="room.suplimentaryOlteanu.single_bed == 1">{{ __('single bed included.') }}</span>
                                                                <span
                                                                    v-if="room.suplimentaryOlteanu.single_bed > 1">{{ __('single beds included.') }}</span>
                                                            </div>
                                                        </div>
                                                        {{-- sofa --}}
                                                        <div class="d-flex items-center"
                                                            ...
                                                            <div class="ml-10">
                                                                @{{ room.suplimentaryOlteanu.sofa }} <span
                                                                    v-if="room.suplimentaryOlteanu.sofa == 1">{{ __('sofa included.') }}</span>
                                                                <span
                                                                    v-if="room.suplimentaryOlteanu.sofa > 1">{{ __('sofas included.') }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="d-flex items-center">
                                        ...
                                        <select v-if="room.childrenPrices" v-model="childrenPrices[childIndex]"
                                            ...
                                            <option v-for="chPrice in room.childrenPrices" :value="chPrice.price"
                                                ...
                                                @{{ chPrice.minimum_age }} - @{{ chPrice.maximum_age }} {{ __('years old') }}
                                        ...
                                        <div class="d-flex items-center">
                                            ...
                                            <select v-model="meals" @change="addMealsDescription($event)"
                                                ...
                                                <option v-bind:value="room.suplimentaryOlteanu.breakfast_price"
                                                    ...
                                                    data-description="{{ __('Breakfast') }}">
                                                    {{ __('Breakfast') }} @{{ formatMoney(room.suplimentaryOlteanu.breakfast_price) }}
                                                </option>
                                                <option v-bind:value="room.suplimentaryOlteanu.demipension_price"
                                                    v-if="room.suplimentaryOlteanu.demipension_active "
                                                    data-description="{{ __('Demipension') }}">
                                                    {{ __('Demipension') }} @{{ formatMoney(room.suplimentaryOlteanu.demipension_price) }}
                                                </option>
                                                <option v-bind:value="room.suplimentaryOlteanu.allinclusive_price"
                                                    data-description="{{ __('All-Inclusive') }}"
                                                    v-if="room.suplimentaryOlteanu.allinclusive_active ">
                                                    {{ __('All-Inclusive') }} @{{ formatMoney(room.suplimentaryOlteanu.allinclusive_price) }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="room-attribute mt-10"
                                        ...
                                        <div class="d-flex items-center">
                                            ...
                                            <select v-model="freecancelation"
                                                class="ml-10 custom-select form-select w-100 rounded-4 border-light px-15 h-50 text-14">
                                                <option selected value="0">
                                                    {{ __('Without freecancelation') }}
                                                </option>
                                                <option v-bind:value="room.suplimentaryOlteanu.freecancelation_price"
                                                    v-if="room.suplimentaryOlteanu.freecancelation_active ">
                                                    {{ __('With freecancelation') }} @{{ formatMoney(room.suplimentaryOlteanu.freecancelation_price) }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="col-6">
                            <div style="font-size:23px; font-weight:500;color:#ff3f19;">
                                <span style="color: #000; font-size: 16px; font-weight: 500;">
                                    {{ __('Total Price') }}:</span> @{{ total_price_html }}
                            </div>
                            <div v-if="is_deposit_ready" class="font-weight-bold"
                                style="font-size:23px; font-weight:500;color:#ff3f19;">
                                <span
                                    style="color: #000; font-size: 16px; font-weight: 500;">{{ __('Pay now') }}</span>
                                @{{ pay_now_price_html }}
                            </div>
                        </div>
                        <div class="col-6">
